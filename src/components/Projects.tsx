  ...
  return (
    <AnimatedSection className="py-8 md:py-10 relative overflow-hidden">
      <div className="container px-4" ref={sectionRef}>
              ...
              <div className="aspect-video relative overflow-hidden">
                ...
                <motion.img
                  ...
                  onError={(e) => {
                    ...
                    target.src = "/projects-images/placeholder.jpg";
                  }}
                />
                <motion.div
              ...
              <div className="p-6 flex-grow flex flex-col">
                ...
                >
                  {project.technologies.map((tech, techIndex) => (
                    <motion.span
                      key={tech}
                      variants={fadeIn("up", techIndex * 0.03) as Variants}
                  ...
                  <div className="mb-6 mt-auto">
                    ...
                    >
                      {project.highlights.slice(0, 2).map((highlight, i) => (
                        <motion.li
                          key={i}
                          variants={fadeIn("left", i * 0.1) as Variants}
                          whileHover={{ x: 2 }}
                        >
                          {highlight}
                        </motion.li>
        ...
        {totalPages > 1 && (
          <motion.div
            variants={fadeIn("up", isMobile ? 0.3 : 0.6) as Variants}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
        ...
        <motion.div
          variants={fadeIn("up", 0.7) as Variants}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
