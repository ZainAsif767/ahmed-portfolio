...
import { fadeIn, slideIn, zoomIn } from "../lib/animation";
...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative py-16 md:py-24">
      ...
      <div className="container px-4 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Hi, I'm <span className="text-blue-600">Ahmed Ismail</span>
          </h1>
          ...
          <motion.p
            variants={fadeIn("up", 0.4) as Variants}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
          ...
          <motion.div
            variants={fadeIn("up", 0.5) as Variants}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
          ...
          >
            <Button asChild size="lg" className="overflow-hidden relative">
              ...
              >
                <motion.div
                  variants={slideIn("left", "tween", 0, 0.5) as Variants}
            ...
            >
              ...
              >
                <motion.div
                  variants={slideIn("right", "tween", 0, 0.5) as Variants}
          ...
          <motion.div
            variants={fadeIn("up", 0.6) as Variants}
            initial="hidden"
            whileInView="show"
            viewport={{ once: true }}
        ...
        <motion.div
          variants={zoomIn(0.5, 0.8) as Variants}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true }}
        ...
        >
          <div className="relative">
            ...
            <motion.div
              ...
              variants={slideIn("right", "spring", 0.8, 0.5) as Variants}
              initial="hidden"
              whileInView="show"
              viewport={{ once: true }}
              whileHover={{
      ...
      <motion.div
        variants={fadeIn("up", 1.2) as Variants}
        initial="hidden"
        whileInView="show"
        viewport={{ once: true }}
