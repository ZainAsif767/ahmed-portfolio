        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400">
              I'm Ahmed Ismail, a passionate Software Engineer. With a strong
              focus on building clean, efficient, and user-friendly web
              applications, I strive to create digital experiences that make a
              positive impact.
            </p>

            <p className="text-gray-600 dark:text-gray-400">
              My journey in software engineering began 5 years ago, and since
              then I've worked on a variety of projects ranging from small
              business websites to complex web applications. I enjoy solving
              problems through code and constantly learning new technologies to
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400">Ahmed Ismail</p>
              </div>
              <div>
